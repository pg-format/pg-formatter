...
Node = CommentLine* WS* id:Value l:Label* p:Property* InlineComment EOL
{
  nodeCount++;
...
Edge = CommentLine* WS* f:Value WS+ d:Direction WS+ t:Value l:Label* p:Property* InlineComment EOL
{
  edgeCount++;
...
CommentLine = WS* (('#' NON_NEWLINE* EOL) / NEWLINE)
{
