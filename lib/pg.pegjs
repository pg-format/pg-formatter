...
Node = EmptyLine* WS* id:Value l:Label* p:Property* (TrailingComment / WS*) EOL
{
  nodeCount++;
...
Edge = EmptyLine* WS* f:Value WS+ d:Direction WS+ t:Value l:Label* p:Property* (TrailingComment / WS*) EOL
{
  edgeCount++;
...
EmptyLine = WS* (('#' NON_NEWLINE_CHAR* EOL) / NEWLINE)
{
...
TrailingComment = WS+ '#' WS+ NON_NEWLINE_CHAR*
