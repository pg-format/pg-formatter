...
function peg$parse(input, options) {
  ...
  var peg$e1 = peg$literalExpectation("true", false);
  var peg$e2 = peg$literalExpectation("false", false);
  ...
  function peg$parseNodeOrEdgeLine() {
    var s0, s1, s2, s3, s4;

    s0 = peg$currPos;
    s1 = [];
    s2 = peg$parseIgnoredLine();
    while (s2 !== peg$FAILED) {
      s1.push(s2);
      s2 = peg$parseIgnoredLine();
    }
