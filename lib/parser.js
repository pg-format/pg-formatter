...
function peg$parse(input, options) {
  ...
  var peg$f15 = function(esc) {
  return esc;
};
  var peg$f16 = function(char) {
  return char;
};
  var peg$f17 = function(esc) {
  return esc;
};
  var peg$f18 = function(a, v) {
  a.push(v);
  return a;
};
