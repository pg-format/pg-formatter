...
function peg$parse(input, options) {
  ...
  var peg$e32 = peg$otherExpectation("UNQUOTED_CHAR");
  var peg$e33 = peg$classExpectation([" ", "\t", "\r", "\n", "'", "\"", "(", ")", ","], true, false);
  var peg$e34 = peg$otherExpectation("WITHOUT_COLON");
  ...
  var peg$f27 = function(char) {
  return char;
};
  var peg$f28 = function(esc) {
  return esc;
};
  var peg$f29 = function(char) {
  return char;
};
  var peg$f30 = function(esc) {
  return esc;
};
  var peg$f31 = function(char) {
  return char;
};
  var peg$f32 = function(esc) {
  return esc;
};
