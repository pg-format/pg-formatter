...
function peg$parse(input, options) {
  ...
  var peg$e26 = peg$otherExpectation("UNQUOTED_CHAR");
  var peg$e27 = peg$classExpectation([["\0", " "], "<", ">", "\"", "{", "}", "|", "^", "`", "\\"], true, false);
  var peg$e28 = peg$otherExpectation("WITHOUT_COLON");
  var peg$e29 = peg$classExpectation([["\0", " "], "<", ">", "\"", "{", "}", "|", "^", "`", "\\", ":"], true, false);
